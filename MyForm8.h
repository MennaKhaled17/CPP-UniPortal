...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// schedule_pn
			// 
			this->schedule_pn->BackColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(45)), static_cast<System::Int32>(static_cast<System::Byte>(45)),
			...
			this->schedule_pn->Size = System::Drawing::Size(708, 331);
			...
			this->pictureBox1->Size = System::Drawing::Size(656, 329);
			...
			this->label2->Text = L"Student ID: 2022/02645";
			// 
			// label4
			// 
			...
			this->label4->Text = L"Student Semester: Third Semester";
			...
			this->ClientSize = System::Drawing::Size(743, 375);
			...
			this->Name = L"MyForm8";
			this->Text = L"MyForm2";
			this->Load += gcnew System::EventHandler(this, &MyForm8::MyForm2_Load);

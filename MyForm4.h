...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label2->Text = L"Student ID: 2022/00000";
			// 
			// label4
			// 
			...
			this->Home_pn->Paint += gcnew System::Windows::Forms::PaintEventHandler(this, &MyForm4::Home_pn_Paint);
			// 
			// pictureBox1
			// 
			...
			this->Name = L"MyForm4";
			this->Text = L"MyForm2";
			this->Load += gcnew System::EventHandler(this, &MyForm4::MyForm2_Load);

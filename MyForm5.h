...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Location = System::Drawing::Point(540, 34);
			this->button1->Name = L"button1";
			this->button1->RightToLeft = System::Windows::Forms::RightToLeft::No;
			this->button1->Size = System::Drawing::Size(103, 107);
			...
			this->label2->Location = System::Drawing::Point(537, 144);
			this->label2->Name = L"label2";
			this->label2->Size = System::Drawing::Size(122, 15);
			this->label2->TabIndex = 3;
			this->label2->Text = L"Dr. Youssef Mahmoud";
			// 
			// label3
			// 
			this->label3->AutoSize = true;
			this->label3->Font = (gcnew System::Drawing::Font(L"Times New Roman", 9, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label3->ForeColor = System::Drawing::SystemColors::ButtonHighlight;
			this->label3->Location = System::Drawing::Point(536, 311);
			this->label3->Name = L"label3";
			this->label3->Size = System::Drawing::Size(104, 15);
			this->label3->TabIndex = 4;
			this->label3->Text = L"Marwan El - Fouly";
			// 
			// label1
			// 
			...
			this->label1->Location = System::Drawing::Point(30, 108);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(427, 73);
			...
			this->button2->Location = System::Drawing::Point(540, 201);
			this->button2->Name = L"button2";
			this->button2->RightToLeft = System::Windows::Forms::RightToLeft::No;
			this->button2->Size = System::Drawing::Size(103, 107);
			this->button2->TabIndex = 5;
			this->button2->UseVisualStyleBackColor = false;
			this->button2->Click += gcnew System::EventHandler(this, &MyForm5::button2_Click_1);
			// 
			// MyForm5
			// 
			...
			this->ClientSize = System::Drawing::Size(725, 390);

...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label2->Text = L"Student ID: 2022/05974";
			// 
			// label4
			// 
			...
			this->label4->Click += gcnew System::EventHandler(this, &MyForm10::label4_Click);
			// 
			// label3
			// 
			...
			this->Home_pn->Paint += gcnew System::Windows::Forms::PaintEventHandler(this, &MyForm10::Home_pn_Paint);
			// 
			// schedule_pn
			// 
			...
			this->Text = L"MyForm2";
			this->Load += gcnew System::EventHandler(this, &MyForm10::MyForm2_Load);
...
#pragma endregion
	...
	private: System::Void textBox1_TextChanged(System::Object^ sender, System::EventArgs^ e) {
		...
		StreamReader^ reader = gcnew StreamReader("Ahmed Ghazouly.txt");

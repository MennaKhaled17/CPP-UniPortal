...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->Home_pn->Paint += gcnew System::Windows::Forms::PaintEventHandler(this, &MyForm3::Home_pn_Paint);
			// 
			// pictureBox1
			// 
			...
			this->Name = L"MyForm3";
			this->Text = L"MyForm2";
			this->Load += gcnew System::EventHandler(this, &MyForm3::MyForm2_Load);
